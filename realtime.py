...
# MODEL_PATH = 'deeplabv3_mnv2_cityscapes_train_2018_02_05.tar.gz'
MODEL_PATH = 'deeplab_cityscapes_xception71_trainfine_2018_09_08.tar.gz'
...
i = 0
cap = cv2.VideoCapture('fau_walk.mp4')   # /dev/video0
while True:
    ret, frame = cap.read()
    if not ret:
        break
    ...
    out = np.vstack((resized_im, seg_im))
